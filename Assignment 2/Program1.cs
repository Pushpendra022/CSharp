...
class Program1
{
    static void Main()
    {
        ...
        user1.SetUsername("Pushpendra");
        user1.SetPassword("12345"); // invalid
        user1.SetPassword("123456"); // valid
        user1.SetEmail("pushpendra@gmail.com"); // invalid
        user1.SetEmail("pushpendra@gmail.com"); // valid
        ...
        user2.SetUsername("Chetan");
        user2.SetPassword("abcdef");
        user2.SetEmail("chetan@example.com");
